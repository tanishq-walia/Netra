...
class Ui_MainWindow_TRAINphNmoisture(object):
    def setupUi(self, MainWindow_TRAINphNmoisture):
        MainWindow_TRAINphNmoisture.setObjectName(_fromUtf8("MainWindow_TRAINphNmoisture"))
        MainWindow_TRAINphNmoisture.resize(221, 331)
        self.centralwidget = QtGui.QWidget(MainWindow_TRAINphNmoisture)
        ...
        MainWindow_TRAINphNmoisture.setCentralWidget(self.centralwidget)

        self.retranslateUi(MainWindow_TRAINphNmoisture)
        QtCore.QMetaObject.connectSlotsByName(MainWindow_TRAINphNmoisture)

    def retranslateUi(self, MainWindow_TRAINphNmoisture):
        MainWindow_TRAINphNmoisture.setWindowTitle(_translate("MainWindow_TRAINphNmoisture", "Train pH & Moisture dataset", None))
        self.checkBox_SUPRESSvisualization.setText(_translate("MainWindow_TRAINphNmoisture", "Suppress Visualization", None))
        self.pushButton_EDIT.setText(_translate("MainWindow_TRAINphNmoisture", "EDIT VALUES", None))
        self.pushButton_EXTRACT.setText(_translate("MainWindow_TRAINphNmoisture", "EXTRACT FEATURES", None))
        self.groupBox.setTitle(_translate("MainWindow_TRAINphNmoisture", "Select Features", None))
        self.pushButton_SELECT.setText(_translate("MainWindow_TRAINphNmoisture", "SELECT IMAGES", None))
        self.radioButton_RGB.setText(_translate("MainWindow_TRAINphNmoisture", "RGB", None))
        self.radioButton_HSV.setText(_translate("MainWindow_TRAINphNmoisture", "HSV", None))
        self.radioButton_NDVI.setText(_translate("MainWindow_TRAINphNmoisture", "NDVI", None))
        self.checkBox_LAB.setText(_translate("MainWindow_TRAINphNmoisture", "LAB TRANFORM", None))
        self.radio_PHVALUE.setText(_translate("MainWindow_TRAINphNmoisture", "pH Value", None))
        self.radio_MOISTURE.setText(_translate("MainWindow_TRAINphNmoisture", "Moisture", None))
