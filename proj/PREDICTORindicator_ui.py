...
# Form implementation generated from reading ui file 'PREDICTORindicator.ui'
#
...
class Ui_MainWindow_PREDICTORindicator(object):
    def setupUi(self, MainWindow_PREDICTORindicator):
        MainWindow_PREDICTORindicator.setObjectName(_fromUtf8("MainWindow_PREDICTORindicator"))
        MainWindow_PREDICTORindicator.resize(739, 459)
        self.centralwidget = QtGui.QWidget(MainWindow_PREDICTORindicator)
        self.centralwidget.setObjectName(_fromUtf8("centralwidget"))
        self.groupBox_3 = QtGui.QGroupBox(self.centralwidget)
        self.groupBox_3.setGeometry(QtCore.QRect(20, 400, 491, 51))
        ...
        self.groupBox_2.setGeometry(QtCore.QRect(520, 10, 211, 441))
        ...
        self.groupBox.setGeometry(QtCore.QRect(20, 10, 491, 381))
        ...
        MainWindow_PREDICTORindicator.setCentralWidget(self.centralwidget)

        self.retranslateUi(MainWindow_PREDICTORindicator)
        QtCore.QMetaObject.connectSlotsByName(MainWindow_PREDICTORindicator)

    def retranslateUi(self, MainWindow_PREDICTORindicator):
        MainWindow_PREDICTORindicator.setWindowTitle(_translate("MainWindow_PREDICTORindicator", "MainWindow", None))
        self.pushButton_SELECT.setText(_translate("MainWindow_PREDICTORindicator", "SELECT FILE", None))
        self.groupBox_2.setTitle(_translate("MainWindow_PREDICTORindicator", "Controls", None))
        self.pushButton_CALCULATEfromStream.setText(_translate("MainWindow_PREDICTORindicator", "CALCULATE FROM STREAM", None))
        self.pushButton_SAVE.setText(_translate("MainWindow_PREDICTORindicator", "SAVE", None))
        self.pushButton_CAPTURE.setText(_translate("MainWindow_PREDICTORindicator", "CAPTURE", None))
        self.pushButton_RESET.setText(_translate("MainWindow_PREDICTORindicator", "RESET", None))
        self.pushButton_CALCULATEfromPath.setText(_translate("MainWindow_PREDICTORindicator", "CALCULATE FROM PATH", None))
        self.radio_NGB.setText(_translate("MainWindow_PREDICTORindicator", "NGB Mode", None))
        self.radio_RGB.setText(_translate("MainWindow_PREDICTORindicator", "RGB Mode", None))
        self.radioButton_RGB.setText(_translate("MainWindow_PREDICTORindicator", "RGB", None))
        self.radioButton_HSV.setText(_translate("MainWindow_PREDICTORindicator", "HSV", None))
        self.radioButton_NDVI.setText(_translate("MainWindow_PREDICTORindicator", "NDVI", None))
        self.pushButton_SET.setText(_translate("MainWindow_PREDICTORindicator", "SET VALUES", None))
        self.radio_MOISTURE.setText(_translate("MainWindow_PREDICTORindicator", "Moisture", None))
        self.radio_PHVALUE.setText(_translate("MainWindow_PREDICTORindicator", "pH Value", None))
        self.checkBox_LAB.setText(_translate("MainWindow_PREDICTORindicator", "LAB SPACE", None))
        self.groupBox.setTitle(_translate("MainWindow_PREDICTORindicator", "Display", None))
        self.label_FEEDLABEL.setText(_translate("MainWindow_PREDICTORindicator", "Feed Label", None))
