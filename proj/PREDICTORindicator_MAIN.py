...
from PREDICTORindicator_ui import Ui_MainWindow_PREDICTORindicator
...
class Gui(QtGui.QMainWindow):
	def __init__(self,parent=None):
		...
		self.ui = Ui_MainWindow_PREDICTORindicator()
	...
	def calculateFromPath(self, subcall = False):
		...
		while True:
			...
			self.output = str(l.predict(targetVector)+2)
