...
from PREDICTORcolour_ui import Ui_MainWindow_PREDICTORcolour
...
class Gui(QtGui.QMainWindow):
	...
	def __init__(self,parent=None):
		...
		self.ui = Ui_MainWindow_PREDICTORcolour()
	...
	def calculateFromPath(self, subcall = False):
		if not subcall:
			self.set()
		while True:
			l = multi.similarityRanking(self.mode, 1, self.supressDATAGraph)
			targetVector = l.getTargetVector(self.recent, self.imageMode, self.LAB)
